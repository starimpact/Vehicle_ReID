...
def BN_MP_Conv(inputdata, kernelsize, numfilter, conv_params, 
               ...
               do_bn=False, bn_params=None, name=''):
    if numfilter > 0:
...
def CreateModel_Color_pre():
    ...
    layers_desc = (
                  ('COV', ((3, 3), 32), ((1, 1), (1, 1), 'max'), False),
                  ('COV', ((3, 3), 32), ((2, 2), (2, 2), 'max'), False),
                  ('COV', ((3, 3), 64), ((1, 1), (1, 1), 'max'), False),
                  ('COV', ((3, 3), 64), ((2, 2), (2, 2), 'max'), False),
                  ('COV', ((3, 3), 128), ((1, 1), (1, 1), 'max'), False), 
                  ('COV', ((3, 3), 128), ((2, 2), (2, 2), 'max'), False), 
                  ('COV', ((3, 3), 256), ((1, 1), (1, 1), 'max'), False), 
                  ('COV', ((3, 3), 256), ((2, 2), (2, 2), 'max'), False), 
                  ('COV', ((3, 3), 512), ((1, 1), (1, 1), 'max'), False), 
                  ('COV', ((3, 3), 512), ((2, 2), (2, 2), 'max'), False), 
                  ('COV', ((3, 3), 1024), ((1, 1), (1, 1), 'max'), False), 
                  ('COV', ((3, 3), 1024), ((2, 2), (2, 2), 'max'), False), 
                  ('COV', ((3, 3), 2048), ((1, 1), (1, 1), 'max'), False), 
                  ('COV', ((3, 3), 2048), ((2, 2), (2, 2), 'max'), False), 
                  ('COV', ((3, 3), 0), ((2, 2), (2, 2), 'max'), False), 
                  )
...
def CreateModel_Color_Split_test():
    ...
    layers_desc = (
                  ('COV', ((3, 3), 64), ((3, 3), (2, 2), 'max'), False),
                  ('COV', ((3, 3), 128), ((3, 3), (2, 2), 'max'), False), 
                  ('COV', ((3, 3), 256), ((3, 3), (2, 2), 'max'), False), 
                  ('COV', ((3, 3), 256), ((3, 3), (2, 2), 'max'), False), 
                  ('COV', ((3, 3), 512), ((3, 3), (2, 2), 'max'), False), 
                  ('COV', ((3, 3), 512), ((3, 3), (2, 2), 'max'), False), 
                  )
